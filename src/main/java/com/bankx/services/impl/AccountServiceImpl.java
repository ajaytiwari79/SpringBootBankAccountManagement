...
public class AccountServiceImpl implements AccountService {
    ...
    @Transactional
    public Transaction depositAmount(DepositAmountRequest depositAmount) {
    ...
    @Transactional
    public Transaction withdrawAmount(WithdrawAmountRequest withdrawAmount) {
    ...
    public List<AccountBalance> interTransfer(CreditTransferRequest transferAmount) {
    ...
    @Transactional
    public boolean creditTransfer(CreditTransferRequest transferAmount) {
